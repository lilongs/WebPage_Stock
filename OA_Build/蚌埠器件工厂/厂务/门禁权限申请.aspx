<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="门禁权限申请.aspx.cs" Inherits="OA_Build.蚌埠器件工厂.厂务.门禁权限申请" %>
    ...
    <table class="ViewForm" style="width: 80%; text-align: center" id="viewForm">
        ...
        <table class="ViewForm" style="width: 80%; text-align: center">
            ...
            <tbody>
                ...
                <tr>
                   <td class="td" colspan="4" align="left"><a href="/docs/module/YZ/root.zip">门禁权限申请模板下载</a></td>
                </tr>
                 <tr>
                    <td class="td">
                        附件
