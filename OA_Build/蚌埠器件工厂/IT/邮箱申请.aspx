<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="邮箱申请.aspx.cs" Inherits="OA_Build.蚌埠器件工厂.IT.邮箱申请" %>
             ...
             <tr>
                ...
                <td class="td">备注</td>
                 <td class="td" colspan="3">
                  1、申请邮箱需完整填写此单，以便做统一规划 <br />
2、账号命名规则：姓名的全拼 <br />
3、开通后请及时更改密码，以免泄密 <br />
4、离职时请向信息化部门申请注销 <br />
5、使用邮箱不得泄露公司机密并遵守法律法规 
                 </td>
                </tr>
                </tbody>
                </table>
