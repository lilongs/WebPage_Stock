<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="移动存储设备权限申请.aspx.cs" Inherits="OA_Build.蚌埠器件工厂.IT.移动存储设备权限申请" %>
             ...
             <tr>
                ...
                <td class="td">权限级别</td>
                 ...
                 <td class="td"></td>
                  ...
                  <tr>
                <td class="td">申请原因说明</td>
                 <td class="td" colspan="3"></td>
                </tr>
                   <tr>
                <td class="td">拷贝文件详细说明</td>
                 <td class="td" colspan="3"></td>
                </tr>
                  <tr>
                    <td class="td" style="background-image: url(/images/s2.png)" colspan="4">
