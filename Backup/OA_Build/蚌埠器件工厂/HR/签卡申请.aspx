<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="签卡申请.aspx.cs" Inherits="OA_Build.蚌埠器件工厂.HR.签卡申请" %>
             ...
             <tr>
                ...
                <td class="td">工号</td>
                 ...
                 <td class="td"></td>
                  ...
                  <tr>
                <td class="td">未刷指纹日期</td>
                 <td class="td"></td>
                  <td class="td">上下班类别</td>
                 <td class="td"></td>
                </tr>
                 <tr>
                <td class="td">未刷指纹原因</td>
