<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="程式开发申请.aspx.cs" Inherits="OA_Build.蚌埠器件工厂.IT.程式开发申请" %>
             ...
             <tr>
                ...
                <td class="td">附件</td>
                 ...
                 <tr>
                  ...
                  <tr>
                <td class="td">需求部门审批</td>
                 <td class="td" colspan="3"></td>
                </tr>
                   <tr>
                <td class="td">开发需求审批</td>
                 <td class="td" colspan="3"></td>
                </tr>
                  <tr>
                <td class="td">IT负责人审批</td>
                 <td class="td" colspan="3"></td>
                </tr>
                 <tr>
                <td class="td">开发人员审批</td>
                 <td class="td" colspan="3"></td>
                </tr>
                <tr>
                <td class="td">需求人确认</td>
                 <td class="td" colspan="3"></td>
                </tr>
                 <tr>
                    <td class="td" style="background-image: url(/images/s2.png)" colspan="4">
