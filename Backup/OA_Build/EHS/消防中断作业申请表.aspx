<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="消防中断作业申请表.aspx.cs" Inherits="OA_Build.EHS.消防中断作业申请表" %>
            ...
            <tr>
             ...
             <tr>
                <td colspan="3" class="td">
                    ...
                    03.在消防系统中断前是否已备妥所有施工准备材料及紧急应变器材（防漏、盛漏设备）？</td>
                <td class="td">
                    Yes____No____N/A____
                </td>
            </tr>
             ...
             <tr>
                <td colspan="3" class="td">
                    ...
                    07.本次作业如果涉及动火作业，是否申请了3E动火作业许可证？</td>
                <td class="td">
                    Yes____No____N/A____
                </td>
            </tr>
             <tr>
                <td colspan="3" class="td">
                    ...
                    08. 本次作业如果涉及高处作业，是否申请了3E高处作业许可证？</td>
                <td class="td">
                    Yes____No____N/A____
                </td>
            </tr>
             <tr>
                <td colspan="3" class="td">
                    ...
                    09. 本次作业如果涉及危害性管路裁接，是否申请了3E危害性管路裁接作业许可证？</td>
                <td class="td">
                    Yes____No____N/A____
                </td>
            </tr>
             <tr>
                <td colspan="3" class="td">
                    ...
                    10.是否已经告知工安人员将消防系统变更情况报备当地消防局？</td>
                <td class="td">
                    Yes____No____N/A____
                </td>
            </tr>
             ...
             <tr>
                <td colspan="3" class="td">
                    ...
                    16.作业临时用电是否依规定提出申请且使用电线须绝缘是否良好无破损？</td>
                <td class="td">
                    Yes____No____N/A____
                </td>
            </tr>
             ...
             <tr>
                ...
                <tr>
                    <td colspan="4" class="td" style="text-align:center;">
                        3E施工负责人签名：_________________日期： _______ 年 _____月_____ 日_____ 时_____ 分
                       </td>
                </tr>
                 <tr>
                    <td colspan="4" style="text-align:right;">
                     编号：3E-WH-EH-WI-1409-09C
                    </td>
                </tr>
            </table>
    </div>
