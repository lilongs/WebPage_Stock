<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="火警侦测器隔离申请表.aspx.cs" Inherits="OA_Build.厂务部_EHS.火警侦测器隔离申请表" %>
        ...
        <table class="ViewForm" style="width: 85% !important" cellspacing="0" cellpadding="0"
            ...
            <tr>
                <td colspan="3" class="td">
                    ...
                    08. 本次作业如果涉及动火作业，是否申请了3E动火作业许可证？</td>
                <td class="td">
                    Yes____No____N/A____
                </td>
            </tr>
            <tr>
                <td colspan="3" class="td">
                    ...
                    09. 本次作业如果涉及高处作业，是否申请了3E高处作业许可证？</td>
                <td class="td">
                    Yes____No____N/A____
                </td>
            </tr>
            <tr>
                <td colspan="3" class="td">
                    ...
                    10. 本次作业如果涉及消防系统中断, 是否申请了3E消防系统中断许可证？</td>
                <td class="td">
                    Yes____No____N/A____
                </td>
            </tr>
            <tr>
                <td colspan="3" class="td">
                    ...
                    11.本次作业如果涉及危害性管路裁接, 是否申请了3E危害性管路裁接作业许可证？</td>
                <td class="td">
                    Yes____No____N/A____
                </td>
            </tr>
            ...
            <tr>
                <td colspan="3" class="td">
                    ...
                    13. 本次作业如果涉及密闭空间(设备),是否申请了密闭空间作业许可证？</td>
                <td class="td">
                    Yes____No____N/A____
                </td>
            </tr>
